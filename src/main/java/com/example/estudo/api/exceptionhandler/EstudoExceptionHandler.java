package com.example.estudo.api.exceptionhandler;
...
@ControllerAdvice
public class EstudoExceptionHandler extends ResponseEntityExceptionHandler {
	...
	String mensagemUsuario = messageSource.getMessage("recurso.usuario-nao-permitido", null, LocaleContextHolder.getLocale());
	...
	//Mensagem de validação do notnull para usuario e dev
	@Override
	...
	//lista de erros sobre a validação 
